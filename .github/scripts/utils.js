 ...
 */
export const getCrateDependencies = (packages, options = {}) => {
  ...
  const deps = output
    ...
    .filter((dep) => dep && dep.includes('kaiki') && !pkgs.includes(dep));
 ...
 */
export const checkFilesAffectCrates = (changedFiles, crates, additionalPaths = []) => {
